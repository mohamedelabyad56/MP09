...
public class AESSecurityService {
    ...
    private static final String ENCRYPT_KEY = "12345678901234567890123456789012"; // 32 caracteres

    public String encripta(String valorOriginal) throws Exception {
        Cipher cipher = Cipher.getInstance(ENCRYPT_ALGORITHM);
        SecretKey key = new SecretKeySpec(ENCRYPT_KEY.getBytes(), ENCRYPT_ALGORITHM);
